            ...
            <div className="border border-dashed border-gray-500 mt-8 shadow-yellow-custom">
              ...
              <div className="grid grid-cols-2">
                {[...Array(4)].map((_, i) => (
                  ...
                  >
                    <img src="/car.jpg" alt="car" className="w-[40%] h-full" />
                    <div className="space-y-2">
                      <p className="text-[8px] font-semibold text-gray-800 line-clamp-3">
                        EXCLUSIVE: Lorem ipsum dolor sit amet consectetur
                        adipisicing elit. Ipsa neque ullam necessitatibus porro.
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Ipsa neque ullam necessitatibus porro.
                      </p>
                    </div>
                  </div>
                ))}
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[8px] font-semibold text-gray-800 line-clamp-5">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Ipsa neque ullam necessitatibus porro. Lorem ipsum dolor sit
                    amet consectetur adipisicing elit. Ipsa neque ullam
